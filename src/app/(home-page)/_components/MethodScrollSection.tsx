...
const STEPS = [
  ...
  },
  {
    ...
    positionClass: "lg:top-[89%] lg:right-[-31%] top-[80%] ",
  },
];
...
export default function MethodScrollSection() {
  ...
  useEffect(() => {
    ...
    const paths = [mobilePathRef.current, desktopPathRef.current].filter(
    ...
    >
      ...
      <LayoutWrapper>
        ...
        <div className="relative z-10">
          ...
          <h2 className="text-[32px] mt-4 lg:mt-[1.6667vw] leading-[100%] lg:leading-[80%] tracking-[-2px] lg:text-[3.33vw] text-white">
            80% Diagnosis. 20% Execution
          </h2>
          <p className="text-[14px] lg:text-[1.25vw] text-[#FFFFFFB8] mt-4 lg:mt-8">
          ...
          <div>
            ...
            >
              <path
                ...
                stroke="url(#paint0_linear_327_1595)"
                strokeLinecap="round"
              />
              <defs>
                <linearGradient
                  id="paint0_linear_327_1595"
                  x1="48.2623"
                  y1="-74.1368"
                  x2="116.831"
                  y2="746.955"
