...
export default function WeBuildUncoverSection() {
  ...
  return (
    <div className="lg:py-[9.72vw] bg-[#1F1F1F]">
      <LayoutWrapper>
        <TextRevealOpacity
          as="h2"
          type="words"
        ...
        >
          ...
          money, time, and confidence. We started Uncover to close it. Before we
          touch a single campaign, we find out what's actually limiting your
          growth, so every dollar you spend goes toward the right problem, not
          the comfortable metric.
        </TextRevealOpacity>
        <div className=" items-center flex w-full justify-center lg:gap-[0.69vw] lg:mt-[3.89vw] ">
