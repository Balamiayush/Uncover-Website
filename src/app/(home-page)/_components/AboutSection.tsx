...
export default function AboutSection() {
  return (
    <div className="py-[48px] lg:py-[8.33vw] w-full h-full bg-white">
      <LayoutWrapper>
        <div className="flex flex-col lg:flex-row ">
          ...
          <TextReveal>
           ...
           Uncover is a diagnosis-first growth-marketing partner. Before we touch a single campaign, we find out what's actually limiting growth, so your next dollar goes to the right problem, not the comfortable metric.
