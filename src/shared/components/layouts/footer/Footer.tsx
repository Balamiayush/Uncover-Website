...
export default function Footer() {
  return (
    <div className="pt-16 pb-6 overflow-x-hidden  relative z-[999] lg:pt-[4.44vw] lg:pb-[2.22vw] bg-black  bg-[url('/images/hero-section-img/hero-section-bg-v1.webp')]  bg-cover bg-center bg-no-repeat">
